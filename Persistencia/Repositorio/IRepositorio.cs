...
namespace Proyecto.Persistencia
{
    public interface IRepositorio
    {
        ...
        IEnumerable<UsuarioMujeres> GetAllMujeres(); // Consultar Mujer
        UsuarioMujeres AddMujeres(UsuarioMujeres mujer); // Crear Mujer
        UsuarioMujeres UpdateMujeres(UsuarioMujeres mujer); // Actualizar MUjer
        void DeleteMujeres(int mujerId); // Eliminar Mujer
        UsuarioMujeres GetMujer(int mujerID); // Buscar un Mujer
    }
}